...
export const AmenitiesSample = () => {
  return (
    <div className="">
      <p className="worldclass">Unforgettable Experience</p>
      <p className=" roomTitle">Our Amenities</p>
        ...
        <div className="row g-0 ">
          ...
          <div className="col-md-10 col-xxl-6 order-1">
            ...
            <div className="card-body">
              <h5 className="card-title same">Swimming Pool</h5>
          ...
          <div className="col-md-10 col-xxl-6 order-1">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                guests to perform a wide variety of workouts. Certified personal
                trainers are available for one-on-one coaching and personalized
                workout plans, while a variety of group fitness classes,
                including yoga, pilates, spinning, and HIIT sessions, offer a
                fun and engaging way to stay fit. Additionally, our gym features
                spacious locker rooms with showers, a relaxing sauna, and
                complimentary towels, ensuring a comfortable and convenient
                workout environment.
              </p>
            </div>
          </div>
          ...
          <div className="col-md-10 col-xxl-6 order-1">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                for socializing and relaxation, featuring a variety of top-tier
                amenities to enhance your experience. The spacious lounge area
                is perfect for unwinding with friends, complete with comfortable
                seating, a large flat-screen TV, and a cozy fireplace. For those
                looking to host events, the clubhouse offers a fully equipped
                kitchen and a stylish dining area, ideal for private parties and
                gatherings. Stay productive with our high-speed Wi-Fi and
                designated workspace, or enjoy some leisure time in the game
                room, which includes a pool table, foosball, and board games.
                The clubhouse also extends to an outdoor patio with BBQ grills
                and seating, providing a perfect spot for alfresco dining and
